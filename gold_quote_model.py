...
joblib.dump(pipeline, os.path.join(directory,'pipeline_gold.pkl'))
models.save_model(model_step.model,os.path.join(directory,'model_gold.h5'))

print("test")

directory2 = os.path.dirname(os.path.realpath(__file__))
pipe = joblib.load(os.path.join(directory2, 'pipeline_gold.pkl'))
model = models.load_model(os.path.join(directory2, 'model_gold.h5'))
