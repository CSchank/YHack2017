...
#respv_par = http.request('GET', "https://v3v10.vitechinc.com/solr/v_participant/select?indent=on&wt=json" + "&q=*:*" + "&rows=1000" + "&fl=id,DOB,city,sex,longitude,latitude,state")
