...
joblib.dump(pipeline, os.path.join(directory,'pipeline_silver.pkl'))
models.save_model(model_step.model,os.path.join(directory,'model_silver.h5'))


print("testing loading")
directory2 = os.path.dirname(os.path.realpath(__file__))
pipe = joblib.load(os.path.join(directory2, 'pipeline_silver.pkl'))
model = models.load_model(os.path.join(directory2, 'model_silver.h5'))
